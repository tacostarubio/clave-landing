    ...
    <main className="flex flex-col min-h-screen">
            ...
            <div className="rounded-2xl overflow-hidden shadow-2xl w-full mx-auto" style={{
              ...
              <div className="p-10 md:p-16 backdrop-blur-sm backdrop-brightness-75">
                ...
                <div className="flex flex-col sm:flex-row gap-6 justify-center mb-20">
                  <a href="/form" className="px-10 py-4 rounded-full bg-white text-black font-medium hover:bg-gray-200 transition-colors flex items-center justify-center text-lg">
                    Start with 3 months free <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ml-2" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" /></svg>
                  </a>
                  <a href="/form" className="px-10 py-4 rounded-full border border-white hover:bg-white hover:text-black hover:border-transparent transition-colors text-lg">
                    Book a Demo
                  </a>
                </div>
                ...
                <div className="max-w-6xl mx-auto rounded-xl overflow-hidden shadow-2xl border border-gray-200/50 bg-white my-12">
                  ...
                  <div className="p-8 bg-gray-50">
                    <div className="grid md:grid-cols-3 gap-6">
                      ...
                      <div className="bg-white rounded-xl shadow-md border border-gray-100">
                        <div className="p-4 flex items-center space-x-3 border-b border-gray-100">
                          <div className="w-10 h-10 bg-[#A9CDCB]/20 rounded-full flex items-center justify-center">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                            </svg>
                          </div>
                          <h3 className="font-bold text-lg text-primary">Revenue Insight</h3>
                        </div>
                        
                        <div className="p-4">
                          <h3 className="text-xl font-bold mb-2 text-primary">Push the 20 Pack churro upsell</h3>
                          <p className="mb-4 text-gray-600">Suggest the "family size" for groups of 3+ people</p>
                          
                          <p className="mb-3 text-sm font-medium text-gray-500">Projected impact:</p>
                          <div className="space-y-2">
                            <div className="bg-gray-900 p-3 rounded-lg">
                              <p className="text-sm text-gray-400">Hourly revenue</p>
                              <p className="text-xl font-bold text-green-400">+$98.40 ↗</p>
                            </div>
                            <div className="bg-gray-900 p-3 rounded-lg">
                              <p className="text-sm text-gray-400">Store perf.</p>
                              <p className="text-xl font-bold text-green-400">Good ↗</p>
                            </div>
                            <div className="bg-gray-900 p-3 rounded-lg">
                              <p className="text-sm text-gray-400">Avg. TPT</p>
                              <p className="text-xl font-bold text-white">3:17 →</p>
                            </div>
                          </div>
                          
                          <button className="w-full p-3 bg-[#A9CDCB] text-primary font-medium rounded-lg mt-4 mb-2 hover:bg-[#98bcba] transition-colors">
                            IMPLEMENT
                          </button>
                          <button className="w-full p-3 text-primary font-medium rounded-lg border border-gray-200 hover:bg-gray-50 transition-colors">
                            Learn more
                          </button>
                        </div>
                      </div>
                      ...
                      <div className="bg-white rounded-xl shadow-md border border-gray-100">
                        <div className="p-4 flex items-center space-x-3 border-b border-gray-100">
                          ...
                          <h3 className="font-bold text-lg text-primary">Staffing Alert</h3>
                        </div>
                        
                        <div className="p-4">
                          <h3 className="text-xl font-bold mb-2 text-primary">Add one more cook from 6-7pm</h3>
                          <p className="mb-4 text-gray-600">Orders are coming in 2.4x faster than they're going out</p>
                          
                          <p className="mb-3 text-sm font-medium text-gray-500">Projected impact:</p>
                          <div className="space-y-2">
                            <div className="bg-gray-900 p-3 rounded-lg">
                              <p className="text-sm text-gray-400">Lost revenue</p>
                              <p className="text-xl font-bold text-red-400">-$173 ↘</p>
                            </div>
                            <div className="bg-gray-900 p-3 rounded-lg">
                              <p className="text-sm text-gray-400">Wait time</p>
                              <p className="text-xl font-bold text-red-400">12:40 ↘</p>
                            </div>
                            <div className="bg-gray-900 p-3 rounded-lg">
                              <p className="text-sm text-gray-400">Customer sat.</p>
                              <p className="text-xl font-bold text-red-400">Low ↘</p>
                            </div>
                          </div>
                      ...
                      <div className="bg-white rounded-xl shadow-md border border-gray-100">
                        <div className="p-4 flex items-center space-x-3 border-b border-gray-100">
                          ...
                          <h3 className="font-bold text-lg text-primary">Inventory Alert</h3>
                        </div>
                        
                        <div className="p-4">
                          <h3 className="text-xl font-bold mb-2 text-primary">Run a 2-hour flash sale on tenders</h3>
                          <p className="mb-4 text-gray-600">Chicken tenders usage is 31% below forecast</p>
                          
                          <p className="mb-3 text-sm font-medium text-gray-500">Projected impact:</p>
                          <div className="space-y-2">
                            <div className="bg-gray-900 p-3 rounded-lg">
                              <p className="text-sm text-gray-400">Waste saved</p>
                              <p className="text-xl font-bold text-green-400">+$87.50 ↗</p>
                            </div>
                            <div className="bg-gray-900 p-3 rounded-lg">
                              <p className="text-sm text-gray-400">Inventory</p>
                              <p className="text-xl font-bold text-green-400">Fresh ↗</p>
                            </div>
                            <div className="bg-gray-900 p-3 rounded-lg">
                    ...
                    <div className="mt-6 p-4 bg-white rounded-lg shadow-sm border border-gray-100 flex justify-between items-center">
                      <p className="text-sm text-gray-500">Next update in 56 minutes</p>
                      <a href="#" className="text-primary font-medium flex items-center hover:text-gray-600 transition-colors">
                        View All Insights <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" /></svg>
                      </a>
                    </div>
                  </div>
                </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-12 md:gap-16 items-center justify-items-center max-w-5xl mx-auto px-4">
            <div className="h-20 w-56 relative grayscale hover:grayscale-0 transition-all">
              <Image
      ...
      {/* Features Section */}
      <section className="py-20 px-4 md:px-6 lg:px-8 bg-gradient-to-b from-white via-gray-200 to-gray-300 text-white">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-16 text-black">Transform Your QSR Operations</h2>
      ...
      {/* Testimonials */}
      <section className="py-32 px-4 md:px-6 lg:px-8 bg-black text-white relative isolate overflow-hidden">
        <div className="container mx-auto max-w-6xl relative z-10">
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-center mb-20 text-white">
            What Operators Say About Clave
          </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
              ...
              <div className="bg-white/10 backdrop-blur-md rounded-xl shadow-md border border-white/20 p-8 text-white transition-all duration-300 hover:bg-white/15 hover:shadow-xl transform hover:-translate-y-1">
                <div className="flex items-center gap-5 mb-5">
                  <div className="h-18 w-18 rounded-full overflow-hidden bg-accent">
                    <Image
                  ...
                  <div>
                    <h4 className="font-semibold text-white text-xl">Luis</h4>
                    <p className="text-sm text-teal-200">220+ stores</p>
                  </div>
                </div>
                <p className="text-white text-lg">"Clave certainly does a lot more than the typical franchisee does. And a lot better. It's a great tool!"</p>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-md rounded-xl shadow-md border border-white/20 p-8 text-white transition-all duration-300 hover:bg-white/15 hover:shadow-xl transform hover:-translate-y-1">
                <div className="flex items-center gap-5 mb-5">
                  ...
                  <div>
                    <h4 className="font-semibold text-white text-xl">Kim</h4>
                    <p className="text-sm text-teal-200">95 stores</p>
                  </div>
                </div>
                <p className="text-white text-lg">"Without Clave, I spend 15 hours a WEEK collecting and analyzing data into an excel and still struggle with making any sense of it."</p>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-md rounded-xl shadow-md border border-white/20 p-8 text-white transition-all duration-300 hover:bg-white/15 hover:shadow-xl transform hover:-translate-y-1">
                <div className="flex items-center gap-5 mb-5">
                  ...
                  <div>
                    <h4 className="font-semibold text-white text-xl">Fernando</h4>
                    <p className="text-sm text-teal-200">15+ stores</p>
                  </div>
                </div>
                <p className="text-white text-lg">"If you give me Clave right now, I'll fire my CEO and use it instead."</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              ...
              <div className="bg-white/10 backdrop-blur-md rounded-xl shadow-md border border-white/20 p-8 text-white transition-all duration-300 hover:bg-white/15 hover:shadow-xl transform hover:-translate-y-1">
                <div className="flex items-center gap-5 mb-5">
                  ...
                  <div>
                    <h4 className="font-semibold text-white text-xl">Werner</h4>
                    <p className="text-sm text-teal-200">400+ stores</p>
                  </div>
                </div>
                <p className="text-white text-lg">"There's lots of tools that put together the data and make it look pretty, but Clave is the only one that goes above and beyond and delivers useful, actionable steps."</p>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-md rounded-xl shadow-md border border-white/20 p-8 text-white transition-all duration-300 hover:bg-white/15 hover:shadow-xl transform hover:-translate-y-1">
                <div className="flex items-center gap-5 mb-5">
                  ...
                  <div>
                    <h4 className="font-semibold text-white text-xl">Ariel</h4>
                    <p className="text-sm text-teal-200">120 stores</p>
                  </div>
                </div>
                <p className="text-white text-lg">"Clave is like having my best operator at every single one of my stores every single day."</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Pricing Section */}
      <section className="py-32 px-4 md:px-6 lg:px-8 bg-black text-white">
        <div className="container mx-auto max-w-6xl">
